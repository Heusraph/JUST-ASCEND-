...
class HealthmaxScreen extends StatelessWidget {
  const HealthmaxScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Colors.white,
      // AppBar with Back Button to return to AscendHome
      appBar: AppBar(
        backgroundColor: Colors.white,
        elevation: 0,
        leading: IconButton(
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Column(
                children: [
                  _buildTag('Morning Sunlight', Alignment.centerLeft),
                  const SizedBox(height: 15),
                  _buildTag('Drink 8L of Water', Alignment.centerRight),
                  const SizedBox(height: 15),
                  _buildTag('Calorie Tracking', Alignment.center),
                  const SizedBox(height: 15),
                  _buildTag('Complete Macros Intake', Alignment.centerLeft),
                  const SizedBox(height: 15),
                  _buildTag('Vitamins Intake', Alignment.centerRight),
                ],
              ),
            ),
