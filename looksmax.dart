...
class LooksmaxScreen extends StatelessWidget {
  const LooksmaxScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Colors.white,
      // AppBar with Back Button to go to Home
      appBar: AppBar(
        backgroundColor: Colors.white,
        elevation: 0,
        leading: IconButton(
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Column(
                children: [
                  _buildTag('Morning Skincare Routine', Alignment.center),
                  const SizedBox(height: 15),
                  _buildTag('GUA SHA', Alignment.centerLeft),
                  const SizedBox(height: 15),
                  _buildTag('Oral Health', Alignment.centerRight),
                  const SizedBox(height: 15),
                  _buildTag('Grooming Maintenance', Alignment.centerLeft),
                  const SizedBox(height: 15),
                  _buildTag('Outfit Styles', Alignment.center),
                ],
              ),
            ),
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          _navItem(context, 'LOOKSMAX', const LooksmaxScreen(), isActive: true),
