...
class MindmaxScreen extends StatelessWidget {
  const MindmaxScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Colors.white,
      // AppBar with Back Button to return to the Home screen
      appBar: AppBar(
        backgroundColor: Colors.white,
        elevation: 0,
        leading: IconButton(
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Column(
                children: [
                  _buildTag('Dopamine Detox', Alignment.centerLeft),
                  const SizedBox(height: 15),
                  _buildTag('Journalism', Alignment.centerRight),
                  const SizedBox(height: 15),
                  _buildTag('Read Bible & Books', Alignment.centerLeft),
                  const SizedBox(height: 15),
                  _buildTag('Learn Language', Alignment.centerRight),
                  const SizedBox(height: 15),
                  _buildTag('Seek God', Alignment.centerLeft),
                ],
              ),
            ),
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          _navItem(context, 'MINDMAX', const MindmaxScreen(), isActive: true),
